...
- Die Cypher-Abfragen beziehen sich auf Daten des Berliner UBahn-Netzes
  ...
  ![(png)](/lv/adbkt/a/shed/bubahn-modell.png)
  - Datenmodell in der Neo4j-Datenbank<br> 
  ![(png)](/lv/adbkt/a/shed/bubahn-modell-neo4j.png)
  - Code 
    - Credentials [(py)](/lv/adbkt/a/ipynb/neo4j.py )
      - Download
      - Umbenennen in cred_neo4j.py
      - Werte anpassen
      - Upload
    - Übertragung der Daten 
      [(ipynb)](/lv/adbkt/a/ipynb/neo4j-fill-mobility.ipynb) 
      [(render)](https://github.com/ic-htw/ic-htw.github.io/blob/master/lv/adbkt/a/ipynb/neo4j-fill-mobility.ipynb)
...
![(png)](/lv/adbkt/a/graph/fig/cypher-abfrage1-ergebnis.png)
...
![(png)](/lv/adbkt/a/graph/fig/cypher-abfrage2-ergebnis.png)